...
// }
  ...
  function getApi () {
  let response =  fetch('https://www.googleapis.com/youtube/v3/search?key=AIzaSyDMSc-Xi3xn7BQaDBEmy2gDNH_9XEc2eDw&channelId=UCSDmYNQ_kSGMp6sGbdA-BjQ&part=snippet,id&order=date&maxResults=20')
  .
  then((response) => {
    return response.json()
  })
